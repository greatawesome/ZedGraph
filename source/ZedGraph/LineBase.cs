...
namespace ZedGraph
{
  ...
  public class LineBase : ICloneable, ISerializable
  {
    ...
    public struct Default
    {
      ...
      internal const string ColorDefault = "0x000000";
    }
    ...
    [Description("The pen width used to draw the line in points")]
    public float Width
    {
      get { return _width; }
      set { _width = value; }
    ...
    [DefaultValue(Default.IsVisible)]
    [Description("Gets or sets a property that shows or hides the line")]
    ...
    [Description("Gets or sets a value that determines if the lines are drawn using Anti-Aliasing capabilities")]
    ...
    /// </remarks>
    /// <seealso cref="Color"/>
    [Description("Gets or sets a custom fill.")]
