...
namespace ZedGraph
{
	...
	{
		//Note: Scrolling not implemented in ZedGraphControl. Scrolling could be handled by a container in Eto.
		//ApplyToAllPanes and Synchronize remain as they're used in non-scrolling related events

		#region ScrollBars

		//    private void handle_Scroll( object sender, ScrollEventArgs e )
		//    {
		//        vScrollBar1_Scroll(this, e.ScrollPosition.Y);
		//        hScrollBar1_Scroll(this, e.ScrollPosition.X);

		//        ProcessEventStuff(sender, e);


		//    }

		//    private void vScrollBar1_Scroll( object sender, int newValue )
		//    {
		...
		//                    HandleScroll(axis, newValue, scroll.Min, scroll.Max, vScrollBar1.LargeChange,
		...
		//    private void hScrollBar1_Scroll( object sender, int newValue )
		//    {
		//        if (this.GraphPane != null)
		//        {
		//            ZoomStateSave(this.GraphPane, ZoomState.StateType.Scroll);

		//            HandleScroll(this.GraphPane.XAxis, newValue, _xScrollRange.Min, _xScrollRange.Max,
		...
		//    private void ProcessEventStuff( object sender, ScrollEventArgs e )
		//    {
